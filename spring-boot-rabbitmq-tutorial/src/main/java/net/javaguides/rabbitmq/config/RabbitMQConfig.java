...
public class RabbitMQConfig {
	...
	@Value("${rabbitmq.queue.name:javaguides}")
	private String queue;
	
	@Value("${rabbitmq.queue.json.name:javaguides_json}")
	...
	public Binding bindingJson() {
		return BindingBuilder.bind(queueJson()).to(exchange()).with(routingKeyJson);
	}
